...
CREATE TABLE `welding_info` (
  ...
  `welding_efficiency` varchar(10)   NOT NULL,
  `welding_splash`     varchar(10)   NOT NULL,
  `welding_model`      varchar(10)   NOT NULL,
  `welding_method`     varchar(10)   NOT NULL,
  `welding_gas`        varchar(10)   NOT NULL,
  `gas_cost`           varchar(10)   NOT NULL,
